...
class DoctorController extends Controller
{
    ...
    public function store(StoreDoctorRequest $request)
    {
        ...
        if ($request->input('picture', false)) {
            $doctor->addMedia(storage_path('tmp/uploads/' . $request->input('picture')))->toMediaCollection('picture');
        }
    ...
    public function show(Doctor $doctor)
    {
        ...
        $doctor->load('doctorAppointments', 'doctorOperations', 'doctorPrescriptions');
