                ...
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.patients.update", [$patient->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group {{ $errors->has('birth_date') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control date" type="text" name="birth_date" id="birth_date" value="{{ old('birth_date', $patient->birth_date) }}">
                        ...
                        <div class="form-group {{ $errors->has('notes') ? 'has-error' : '' }}">
                            ...
                            <textarea class="form-control ckeditor" name="notes" id="notes">{!! old('notes', $patient->notes) !!}</textarea>
                            @if($errors->has('notes'))
                        ...
                        <div class="form-group {{ $errors->has('blood_type') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="blood_type" id="blood_type" value="{{ old('blood_type', $patient->blood_type) }}">
                        ...
                        <div class="form-group {{ $errors->has('status') ? 'has-error' : '' }}">
                            ...
                            <select class="form-control" name="status" id="status">
                                ...
                                @foreach(App\Models\Patient::STATUS_SELECT as $key => $label)
                                    <option value="{{ $key }}" {{ old('status', $patient->status) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group {{ $errors->has('payment') ? 'has-error' : '' }}">
                            ...
                            <select class="form-control" name="payment" id="payment">
                                ...
                                @foreach(App\Models\Patient::PAYMENT_SELECT as $key => $label)
                                    <option value="{{ $key }}" {{ old('payment', $patient->payment) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group {{ $errors->has('debt') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="debt" id="debt" value="{{ old('debt', $patient->debt) }}" step="0.01">
                            @if($errors->has('debt'))
                        ...
                        <div class="form-group {{ $errors->has('payed') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="payed" id="payed" value="{{ old('payed', $patient->payed) }}" step="0.01">
                            @if($errors->has('payed'))
